...
def Net():
    model = models.resnet34(pretrained=True) # using the pretrained resnet34 model 
    ...
    model.fc = nn.Sequential(
                   ...
                   nn.Linear(512, 256), # adding fully connected NN layers to the output of the pretrained model
                   nn.ReLU(inplace=True),
